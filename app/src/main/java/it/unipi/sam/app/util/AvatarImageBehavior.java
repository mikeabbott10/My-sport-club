...
public class AvatarImageBehavior extends CoordinatorLayout.Behavior<CircleImageView> {
    ...
    private final static String TAG0 = "UTILAvatarImageBehavior";
    ...
    public boolean layoutDependsOn(@NonNull CoordinatorLayout parent, @NonNull CircleImageView child, @NonNull View dependency) {
        //DebugUtility.LogDThis(DebugUtility.UI_RELATED_LOG, TAG0, "layoutDependsOn.dependency="+dependency, null);
    ...
    public boolean onDependentViewChanged(@NonNull CoordinatorLayout parent, @NonNull CircleImageView child, @NonNull View dependency) {
        ...
        //DebugUtility.LogDThis(DebugUtility.UI_RELATED_LOG, TAG0, "onDependentViewChanged.parent="+parent, null);
        //DebugUtility.LogDThis(DebugUtility.UI_RELATED_LOG, TAG0, "onDependentViewChanged.child="+child, null);
        //DebugUtility.LogDThis(DebugUtility.UI_RELATED_LOG, TAG0, "onDependentViewChanged.dependency="+dependency, null);
        final int maxScrollDistance = (int) (mStartToolbarPosition);
        float expandedPercentageFactor = dependency.getY() / maxScrollDistance;

        if (expandedPercentageFactor < mChangeBehaviorPoint) { // here subtract even on x-axis
    ...
    private void maybeInitProperties(CircleImageView child, View dependency) {
        ...
        if (mFinalXPosition == 0)
            // abc_action_bar_content_inset_material: Default content inset of an action bar. (16dp)
            // from https://web.archive.org/web/20220529212135/https://chromium.googlesource.com/android_tools/+/refs/heads/main/sdk/extras/android/support/v7/appcompat/res/values/dimens_material.xml
