...
public class MaleFragment extends Fragment implements Observer< List<Map<String, String>> > {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        currentFragmentName = requireActivity().getString(R.string.menu_maschile);
        viewModel = new ViewModelProvider(requireActivity()).get(ItemViewModel.class);

        LinearLayoutManager llm = new LinearLayoutManager(getActivity());
        binding.teamsRecyclerView.setLayoutManager(llm);
        ...
        viewModel.getMaleTeamsList().observe(getViewLifecycleOwner(), this);
        return root;
    }
